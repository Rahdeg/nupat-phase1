...
const News = ({img,title,date,titleColor,bottom}) => {
  return (
    <div className='flex  border-t-2  mt-4' style={ bottom && {borderBottom:`${bottom}`}}>
...
<path d="M1 19.667H52.3333" stroke="#1C1F35" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <h1 className=' text-heading text-xl font-bold' style={{color:`${titleColor}` }}> {title} </h1>
    <p className='  text-sm'> We are dedicated in creating added value<br/>for our customers by implementing modern<br/> technoloy in our work</p>
