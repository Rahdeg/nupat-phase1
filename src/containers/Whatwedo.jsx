  ...
  return (
    <div className="flex  justify-center gap-56 mt-10">
      <div className="flex flex-col ">
        ...
        <h1 className=" text-heading font-bold text-2xl">
      ...
      <div className=" grid grid-cols-2 gap-6">
        <IconWithText
          ...
          text1="Sea Transport Services"
          text2={
            <h2>
              Following the quality of our services
