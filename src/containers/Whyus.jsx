...
const Whyus = () => {
  return (
    ...
    <h1 className=' text-heading font-bold text-2xl py-1'>We provide full range global<br/> logistics solution</h1>
    <p className=' text-paragraph font-semibold text-sm py-1'>Leverage agile frameworks to provide a robust synopsis for <br/>strategy foster collaborative thinking to further the overall<br/> value proposition</p>
    <p className='text-paragraph font-semibold text-sm py-1'> Organically grow the holistic world view of disruptive<br/> innovation via workplace diversity and empowerment</p>
    ...
    <path d="M42.9643 21H16.0357C15.4637 21 15 21.4477 15 22V36C15 36.5523 15.4637 37 16.0357 37H42.9643C43.5363 37 44 36.5523 44 36V22C44 21.4477 43.5363 21 42.9643 21Z" stroke="#1C1F35" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    </svg>} text='Optimized Travel Cost'/>
    </div>
    <div className='relative flex flex-col   m-3 p-3 mb-60'>
    <Image src={IMG2} alt='ss' width={300} className=' '/>
    <Image src={IMG3} alt='ss' width={300} className=' absolute -bottom-24 -left-24'/>
